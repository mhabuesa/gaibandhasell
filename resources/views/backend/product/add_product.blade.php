...
@push('title')
<title>Add Product | Gaibandhasell.com</title>
@endpush
@push('header')
    	<!-- Selectize -->
    <link
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input required type="text" name="tags" placeholder="Tags Here"  id="input-tags" value="" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="short_desp" id="" cols="30" rows="5" ></textarea>
                                </div>
                                @error('short_desp')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="summernote" class="form-control" name="long_desp"></textarea>
                                </div>
                                @error('long_desp')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                                ...
                                <div class="mb-3">
                                   ...
                                   <div class="upload__btn-box">
                                        <label class="upload__btn">
                                            ...
                                            <input required type="file" name="preview" multiple="" data-max_length="20"
                                                class="upload__inputfile" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        </label>
                                        <img class="mt-3" height="150" id="blah" src="" title="Product Image" alt="">
                                    </div>
                                </div>
                                @error('preview')
                                    <small class="text-danger">{{$message}}</small>
                                ...
                                <div class="upload__box">
                                    <div class="upload__btn-box">
                                        <label class="upload__btn">
                                            ...
                                            <input required type="file" name="gallery[]" multiple="" data-max_length="20"
